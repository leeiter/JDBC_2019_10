...
public abstract class ScoreService {
	...
	protected void dbConnection() {
		try {
			...
			dbConn = DriverManager.getConnection(DBContract.DbConn.URL, DBContract.DbConn.USER, DBContract.DbConn.PASSWORD);
			...
			// TODO Auto-generated catch block
			System.out.println("DBMS 접속 오류!! JDBC 드라이버를 찾지 못함!!");
		}
	}
