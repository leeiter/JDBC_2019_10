...
public class BookCUDServiceV1 {
	...
	public void inputBook() {
		...
		while(true) {
			...
			int ret = bookDao.intsert(bookDTO);
			if(ret > 0)
	...
	public void updateBook() {
		...
		// NumberFormatException 이 발생하는 것을
		// 역 이용하여ㅛ
		// 만약 값을 읿력하면 해당하는 값을 DTO에 저장하고
		// 그렇지 않으면 건너뛰도록 코딩
		
		// 여기 도착했을 때
		// bookDTO에 담긴 값은 
		// 처음에 table에 서 읽은 값이 저장되어 있거나
		// 중간에 키보드로 입력한 값으로 변경 되었거나 한다.
